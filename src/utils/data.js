...
const TestimonialData = [
  {
    ...
    authorName: "Jason Pietruszka",
    authorTitle: "CEO At JJP Construction INC",
    quoteTitle: "",
    authorQuote: "Nexus Team delivered good work on this project, and I enjoyed working with them. Their communication was top-notch, they met all deadlines, and their skills were reasonably strong. At one point, I asked for an additional milestone, and they were very forthcoming that the additional work was outside their area of expertise. I enjoyed working with Nexus Team and will likely have additional jobs for them in the future."
  },
  {
    id: 2,
    authorImg: "/testimonial/2.jpg",
    authorName: "Elie Nabushosi",
    authorTitle: "SAVVYGENIES.COM",
    quoteTitle: "Best Template for SAAS Company!",
    authorQuote: "Nexus Team has consistently demonstrated exceptional engineering skills throughout the project. Their ability to tackle complex search algorithms and optimize performance was truly impressive."
  },
  {
    id: 3,
    authorImg: "/testimonial/3.jpg",
    authorName: "Roman Sandler",
    authorTitle: "CEO AT ICARDIO.AI",
    quoteTitle: "It is undeniably good!",
    authorQuote: "I had a great experience working with Nexus Team on my Upwork project. They delivered exceptional work ahead of schedule, demonstrating excellent communication and customer service throughout the process. Proficient in Python, Django, and REST API integration, Nexus Team developed a continuous web service for generating and saving user posts with an intuitive graphical interface for content review. They also implemented a secure database for user content. I highly recommend Nexus Team for any web development project and look forward to future collaborations. Thank you for the exceptional work!"
  },
  {
    id: 4,
    authorImg: "/testimonial/4.jpg",
    authorName: "Aubin C.",
    authorTitle: "CEO AT AMPLIFY FEED",
    quoteTitle: "",
    authorQuote: "Exemplified strong leadership qualities and a proactive approach in their designated role, showcasing an influential and impactful presence within the team or project."
  },
];
